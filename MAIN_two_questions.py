...
# Adding columns 'State_name', 'State_code' and 'State_abbr' to the dataframe:
...
#########################################################################################################
# Q1: Top 20 US-states where is the highest percentage of Foreign-born with the high income (65+K) out of total_FB
#     VS Natives the high income (65+K) out of total_Natives:
